...
def callback_Init(data):
  ...
  [yaw, pitch, roll] = quaternion_to_euler(pos_msg_0.orientation.x, pos_msg_0.orientation.y, pos_msg_0.orientation.z, pos_msg_0.orientation.w)
  position_0 = [pos_msg_0.position.x,pos_msg_0.position.y,pos_msg_0.position.z,yaw, pitch, roll]
...
# def APF_Fn(Rob_pos, Goal_pos, Obs_pos_list, APF_Param):
#     global Fx_att
#     global Fy_att
#     global d_obs
#     global Fx_rep
...
#         Fx_rep_total += Fx_rep_val
#         Fy_rep_total += Fy_rep_val

#     Fx_net_val = Fx_att_val + Fx_rep_total
#     Fy_net_val = Fy_att_val + Fy_rep_total

#     return [Fx_net_val, Fy_net_val]
...
#    magnitude = sqrt(Des_Pos_msg.orientation.x**2 + Des_Pos_msg.orientation.y**2 + Des_Pos_msg.orientation.z**2 + Des_Pos_msg.orientation.w**2)

# #Normalize quaternion
#    Des_Pos_msg.orientation.x /= magnitude
#    Des_Pos_msg.orientation.y /= magnitude
#    Des_Pos_msg.orientation.z /= magnitude
#    Des_Pos_msg.orientation.w /= magnitude

#    marker.pose.position.x = 0.0
#    marker.pose.position.y = 0.0
#    marker.pose.position.z = 0.0
#    marker.pose.orientation.x = Des_Pos_msg.orientation.x
#    marker.pose.orientation.y = Des_Pos_msg.orientation.y
#    marker.pose.orientation.z = Des_Pos_msg.orientation.z
#    marker.pose.orientation.w = Des_Pos_msg.orientation.w
